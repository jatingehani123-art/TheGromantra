...
export const KineticTypographyLoader = () => {
    ...
    const words = ["INITIALIZING", "ACCELERATING", "ENGINEERING"];
    ...
    return (
        <div className="loader-container">
            <h1 ref={loaderTextRef} className="text-4xl sm:text-6xl lg:text-8xl font-extrabold text-gromantra-glow whitespace-nowrap">
            </h1>
        </div>
    );
};
