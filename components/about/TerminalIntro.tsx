...
This is an end-to-end growth infrastructure built for scale.`
  ...
  return (
    <section ref={containerRef} className="py-32 bg-[#050508] relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(29,78,216,0.30),transparent_50%)] blur-3xl opacity-30" style={{ zIndex: -10, pointerEvents: 'none' }} />
